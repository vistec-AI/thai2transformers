...
python -m torch.distributed.launch \
    ...
    --ext .txt \
    --train_path $BASE_DIR/dataset/split/thwiki-for-ddp_4.11.2020/train/train.txt \
    --eval_path $BASE_DIR/dataset/split/thwiki-for-ddp_4.11.2020/val/val.txt \
    ...
    --eval_steps 2500 \
    --logging_dir $BASE_DIR/logs/debug_exp011_thwiki-4.11.2020_spm_vs-24k_fp32_bz32_maxstep-10k_ngpus-4_maxseqlen-416_mlmdataset \
    --output_dir $BASE_DIR/checkpoints/debug_exp011_thwiki-4.11.2020_spm_vs-24k_fp32_bz32_maxstep-10k_ngpus-4_maxseqlen-416_mlmdataset \
    --add_space_token \
    --binarized_dir_train $BASE_DIR/dataset/binarized/thwiki-for-ddp_4.11.2020/train/ \
    --binarized_dir_val $BASE_DIR/dataset/binarized/thwiki-for-ddp_4.11.2020/val/
